push <- function(files) {
  ...
  sftpSite = pushPull::dtf$value[dtf$key=="sftpSite"]
  sftpName = pushPull::dtf$value[dtf$key=="sftpName"]
  sftpPassword = pushPull::dtf$value[dtf$key=="sftpPassword"]
  userName = pushPull::dtf$value[dtf$key=="userName"]
